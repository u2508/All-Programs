...
class GeeksforGeeks(QWidget):
	...
	def Download(self):
		...
		down_url = ('https://youtu.be/zFdi834FiZ4') # specify download url here
		
		# specify save location where the file is to be saved
		save_loc = "C:\\Users\\utkar\\Desktop\\music.mp4"

		# Downloading using urllib
		urllib.request.urlretrieve(down_url,save_loc, self.Handle_Progress)
	def download(self):
		down_url = ('https://youtu.be/zFdi834FiZ4') # specify download url here
		url = YouTube(down_url)
		video = url.streams.first()
		video.download( "E:/",self.Handle_Progress)    
